...
This slowdown is primarily attributed to the overhead introduced by the initial startup of the Prolog engine, which occurs for every optimization and is more pronounced in the case of stateful optimizations.
